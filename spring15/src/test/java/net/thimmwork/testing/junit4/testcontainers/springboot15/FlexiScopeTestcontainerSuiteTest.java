...
@RunWith(Suite.class)
@Suite.SuiteClasses({FlexiScopeTestcontainerSuiteTest.FlexiScopeTestClass.class, FlexiScopeTestcontainerSuiteTest.FlexiScopeTestClass.class})
public class FlexiScopeTestcontainerSuiteTest {

    @ClassRule public static PostgreSQLContainer POSTGRES = new PostgreSQLContainer();
    ...
    public static class FlexiScopeTestClass {
        ...
        @ClassRule @Rule
        public static PostgreSQLContainer DATABASE = FlexiScopeTestcontainerSuiteTest.POSTGRES;
